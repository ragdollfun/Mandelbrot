...
HD_PWD='C:/Users/Petr/Xilinx/Mandelbrot/designs/vivado/mandelbrot_pinout/2018.2/mandelbrot_pinout.runs/clk_mandelbrot_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_mandelbrot.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_mandelbrot.tcl
